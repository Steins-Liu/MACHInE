...
# Public Domain
#-------------------------------------------------------------------------------
# A modified implementation of the read_RPM.py script obtained from the pigpio library 
# by Joan (Github joan2937), January 2016,
# Public Domain.
#-------------------------------------------------------------------------------
...
class reader:
   ...
   """
   def __init__(self, pi, gpio, pulses_per_rev=2.0, weighting=0.0, min_RPM=0.0):
      """
