...
float ACCEL_X_MIN = -271.61;
float ACCEL_X_MAX = 262.94;
float ACCEL_Y_MIN = -265.38;
float ACCEL_Y_MAX = 262.57;
float ACCEL_Z_MIN = -254.39;
float ACCEL_Z_MAX = 278.93;
...
float magn_ellipsoid_center[3] = {327.564, -306.444, 259.877};
float magn_ellipsoid_transform[3][3] = {{0.869382, -0.00555386, 0.260701}, {-0.00555386, 0.644093, -0.121438}, {0.260701, -0.121438, 0.430287}};
