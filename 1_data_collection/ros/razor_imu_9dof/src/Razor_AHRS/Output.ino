...
void output_both_angles_and_sensors_text()
{
  ...
  float vin = (value * 5.0) / 1024.0 /(7500.0/(30000.0+7500.0)) - 4;
  char voltage[4];
  dtostrf(vin, 4, 2, voltage);
  ...
  LOG_PORT.print(voltage[0]); 
  LOG_PORT.print(voltage[1]); 
  LOG_PORT.print(voltage[2]); 
  LOG_PORT.print(voltage[3]); LOG_PORT.println();
}
